 ...
 */
class Bio_phi extends MY_Controller 
{
    ...
    {	
		...
		$data['title'] = "T H I R R A - PHI Main Page";
        ...
        $data['count_fresh_list'] = count($data['total_fresh_list']);
		$data['total_open_list'] = $this->mbio->get_disease_notified_list("open","ALL",0);
        $data['count_open_list'] = count($data['total_open_list']);
		$data['total_closed_list'] = $this->mbio->get_disease_notified_list("closed","ALL",0);
        $data['count_closed_list'] = count($data['total_closed_list']);
		$data['main'] = 'home';
    ...
    {	
        ...
        switch ($_SESSION['thirra_mode']){
            ...
            case "bio_broad":
                ...
                $new_body   =   "bio/bio_cases_mgt_html";
                $new_footer =   "bio/footer_bio_html";
                break;			
            case "bio_hospital":
                //$new_header =   "bio/header_xhtml1-strict";
    ...
    {	
        ...
        $config['base_url'] = base_url().'/index.php/bio_phi/cases_fresh/';
        ...
        switch ($_SESSION['thirra_mode']){
            case "bio_mobile":
                $new_header =   "bio/header_xhtml-mobile10";
                $new_banner =   "bio/banner_bio_wap";
                $new_sidebar=   "bio/sidebar_bio_cases_wap";
                $new_body   =   "bio/bio_cases_fresh_wap";
                $new_footer =   "bio/footer_bio_wap";
                break;			
            case "bio_broad":
                //$new_header =   "bio/header_xhtml1-strict";
                ...
                $new_banner =   "bio/banner_bio_html";
                $new_sidebar=   "bio/sidebar_bio_cases_html";
                $new_body   =   "bio/bio_cases_fresh_html";
                $new_footer =   "bio/footer_bio_html";
                break;			
            case "bio_hospital":
                //$new_header =   "bio/header_xhtml1-strict";
    ...
    {	
        ...
        $config['base_url'] = base_url().'/index.php/bio_phi/cases_open/';
        ...
        switch ($_SESSION['thirra_mode']){
            case "bio_mobile":
                ...
                $new_banner =   "bio/banner_bio_wap";
                $new_sidebar=   "bio/sidebar_bio_cases_wap";
                $new_body   =   "bio/bio_cases_open_wap";
                $new_footer =   "bio/footer_bio_wap";
                break;			
            case "bio_broad":
                //$new_header =   "bio/header_xhtml1-strict";
                ...
                $new_banner =   "bio/banner_bio_html";
                $new_sidebar=   "bio/sidebar_bio_cases_html";
                $new_body   =   "bio/bio_cases_open_html";
                $new_footer =   "bio/footer_bio_html";
                break;			
            case "bio_hospital":
                //$new_header =   "bio/header_xhtml1-strict";
    ...
    {	
        ...
        $config['base_url'] = base_url().'/index.php/bio_phi/cases_closed/';
        ...
        switch ($_SESSION['thirra_mode']){
            case "bio_mobile":
                ...
                $new_banner =   "bio/banner_bio_wap";
                $new_sidebar=   "bio/sidebar_bio_cases_wap";
                $new_body   =   "bio/bio_cases_closed_wap";
                $new_footer =   "bio/footer_bio_wap";
                break;			
            case "bio_broad":
                //$new_header =   "bio/header_xhtml1-strict";
                ...
                $new_banner =   "bio/banner_bio_html";
                $new_sidebar=   "bio/sidebar_bio_cases_html";
                $new_body   =   "bio/bio_cases_closed_html";
                $new_footer =   "bio/footer_bio_html";
                break;			
            case "bio_hospital":
                //$new_header =   "bio/header_xhtml1-strict";
    ...
    function edit_case($bio_case_id = NULL)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        $data['map_server']		    =	$this->config->item('map_server');

		$data['title'] = 'Add/Edit Case';
		$data['main'] = 'bio_case';
		...
		$data['clinics_list'] = $this->mbio->get_clinics_list("Sri Lanka");
        if(count($_POST)) {
            // User has posted the form
            $data['init_case_ref']          =   $_POST['case_ref'];
            $data['init_location_id']     	=   $_POST['phi_range'];
            $data['init_bio_phi_ref']       =   $_POST['bio_phi_ref'];
            $data['init_case_prior_movements']=   $_POST['case_prior_movements'];
            $data['init_case_findings']     =   $_POST['case_findings'];
			if(isset($_POST['case_outbreak_degree'])){
				$data['init_case_outbreak_degree']         =   $_POST['case_outbreak_degree'];
			}
			if(isset($_POST['case_in_outbreak'])){
				$data['init_case_in_outbreak']         =   $_POST['case_in_outbreak'];
			}
			...
			if(isset($_POST['alert_now'])){
				$data['init_alert_now']         =   $_POST['alert_now'];
			}
            $data['init_case_location_isolation']=   $_POST['case_location_isolation'];
            $data['init_discharged_date']     =   $_POST['discharged_date'];
			if(isset($_POST['case_clinical_outcome'])){
				$data['init_case_clinical_outcome']         =   $_POST['case_clinical_outcome'];
			}
            $data['init_case_disease_confirmed'] =   $_POST['case_disease_confirmed'];
            $data['init_date_disease_confirmed'] =   $_POST['date_disease_confirmed'];
            ...
            //if (is_null($bio_case_id)){
                ...
                $data['init_bio_phi_ref']       =   NULL;
                $data['init_location_id']       =   $_SESSION['location_id'];
                $data['init_district_id']       =   NULL;
                $data['init_case_location_isolation'] =   "Hospital";
                $data['init_case_clinical_outcome'] =   NULL;
                $data['init_case_disease_confirmed']=   NULL;
                $data['init_date_disease_confirmed']=   NULL;
                $data['init_gps_lat']           =   NULL;
                $data['init_gps_long']          =   NULL;
                $data['init_case_prior_movements']=   NULL;
                $data['init_case_findings']     =   NULL;
                $data['init_case_outbreak_degree']=   NULL;
                $data['init_case_in_outbreak']	=   NULL;
                ...
                $data['init_bio_phi_ref']       =   $data['bio_case_details']['bio_phi_ref'];
                $data['init_location_id']       =   $data['bio_case_details']['location_id'];
                $data['init_case_location_isolation']=   $data['bio_case_details']['case_location_isolation'];
                $data['init_case_clinical_outcome'] =   $data['bio_case_details']['case_clinical_outcome'];
                $data['init_case_disease_confirmed']=   $data['bio_case_details']['case_disease_confirmed'];
                $data['init_date_disease_confirmed']=   $data['bio_case_details']['date_disease_confirmed'];
                $data['init_gps_lat']           =   $data['bio_case_details']['gps_lat'];
                $data['init_gps_long']          =   $data['bio_case_details']['gps_long'];
                $data['init_case_prior_movements']=   $data['bio_case_details']['case_prior_movements'];
                $data['init_case_findings']     =   $data['bio_case_details']['case_findings'];
                $data['init_case_outbreak_degree']=   $data['bio_case_details']['case_outbreak_degree'];
                $data['init_case_in_outbreak']	=   $data['bio_case_details']['case_in_outbreak'];
		...
		if ($this->form_validation->run('edit_case') == FALSE){
            ...
            if($data['save_attempt'] == "NEW CASE"){
                ...
                $ins_case_array['bio_phi_ref']           =   $data['init_bio_phi_ref'];
                $ins_case_array['location_id']           =   $data['init_location_id'];
                $ins_case_array['case_prior_movements']  =   $data['init_case_prior_movements'];
                $ins_case_array['case_findings']         =   $data['init_case_findings'];
                if(isset($data['init_case_outbreak_degree'])){
                    $ins_case_array['case_outbreak_degree'] =   $data['init_case_outbreak_degree'];
                }
                if(isset($data['init_case_in_outbreak'])){
                    $ins_case_array['case_in_outbreak'] =   $data['init_case_in_outbreak'];
                }
                $ins_case_array['case_summary']          =   $data['init_case_summary'];
                $ins_case_array['case_location_isolation']=   $data['init_case_location_isolation'];
                $ins_case_array['adt_id']		         =   $data['notify_info']['adt_id'];
                if($data['init_discharged_date']){
                    $ins_case_array['discharged_date'] =   $data['init_discharged_date'];
                }
                if(isset($data['init_case_clinical_outcome'])){
                    $ins_case_array['case_clinical_outcome'] =   $data['init_case_clinical_outcome'];
                }
                if(isset($data['init_case_disease_confirmed'])){
                    $ins_case_array['case_disease_confirmed'] =   $data['init_case_disease_confirmed'];
                }
                if($data['init_date_disease_confirmed']){
                    $ins_case_array['date_disease_confirmed'] =   $data['init_date_disease_confirmed'];
                }
                ...
                $data['bio_case_id']                    = $data['now_id'];  // convert purpose after insertion
            } else {
        		$data['save_attempt'] = 'Updated successfully';
                $upd_case_array   =   array();
                $upd_case_array['staff_id']        		=   $_SESSION['staff_id'];
                $upd_case_array['bio_case_id']          =   $data['init_bio_case_id'];
                $upd_case_array['case_ref']             =   $data['init_case_ref'];
                $upd_case_array['bio_phi_ref']          =   $data['init_bio_phi_ref'];
                $upd_case_array['location_id']          =   $data['init_location_id'];
                $upd_case_array['case_prior_movements'] =   $data['init_case_prior_movements'];
                $upd_case_array['case_findings']        =   $data['init_case_findings'];
                $upd_case_array['case_outbreak_degree'] =   $data['init_case_outbreak_degree'];
                $upd_case_array['case_in_outbreak'] 	=   $data['init_case_in_outbreak'];
                $upd_case_array['case_summary']         =   $data['init_case_summary'];
                $upd_case_array['case_location_isolation']=   $data['init_case_location_isolation'];
                $upd_case_array['case_clinical_outcome'] =   $data['init_case_clinical_outcome'];
                $upd_case_array['case_disease_confirmed'] =   $data['init_case_disease_confirmed'];
                $upd_case_array['date_disease_confirmed'] =   $data['init_date_disease_confirmed'];
                ...
                if($data['init_discharged_date']){
                    $upd_case_array['discharged_date'] =   $data['init_discharged_date'];
					$upd_case_array['adt_id']		   =   $data['notify_info']['adt_id'];
                }
    ...
    // ------------------------------------------------------------------------
    function edit_inv($bio_inv_id = NULL) // Investigations Form
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        $data['map_server']		    =	$this->config->item('map_server');
        ...
        if(count($_POST)) {
            ...
            $data['init_inv_main_age']  	=   $_POST['inv_main_age'];
			if(isset($_POST['inv_main_contacttype'])){
				$data['init_inv_main_contacttype']=   $_POST['inv_main_contacttype'];
			} else {
				$data['init_inv_main_contacttype']=   NULL;
			}
            ...
            if($data['form_purpose'] == 'new_inv') {
                ...
                $data['init_inv_main_age']     =   NULL;
                $data['init_inv_main_contacttype']=   NULL;
                $data['init_inv_main_sex']	   =   NULL;
                ...
                $data['init_inv_main_age']     =   $data['bio_inv_details']['inv_main_age'];
                $data['init_inv_main_contacttype']=   $data['bio_inv_details']['inv_main_contacttype'];
                $data['init_inv_main_sex']	   =   $data['bio_inv_details']['inv_main_sex'];
    ...
    */
                ...
                $ins_inv_array['inv_main_age']      	=   $data['init_inv_main_age'];
                $ins_inv_array['inv_main_contacttype']      =   $data['init_inv_main_contacttype'];
                ...
                $upd_inv_array['inv_main_age']      =   $data['init_inv_main_age'];
                $upd_inv_array['inv_main_contacttype']      =   $data['init_inv_main_contacttype'];
                if($data['init_inv_cluster_size']){
    ...
    // ------------------------------------------------------------------------
    function edit_patient($patient_id = NULL) // TO DEPRECATE?
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['form_purpose']   = $this->uri->segment(3);
    ...
    // ------------------------------------------------------------------------
    function print_form411($id=NULL)  // template for new classes
    {
		$data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
	  	//$this->load->model('memr');
		$data['title'] = "T H I R R A - Form 411";
		$data['now_id']             =   time();
		...
		$data['notify_info']          =   $this->mbio->get_disease_notify_details($data['patient_id'],$data['notification_id']);
		$data['bio_case_details']     =   $this->mbio->get_case_details_only($data['bio_case_id']);
		$data['case_disease_confirmed']=   $data['bio_case_details']['case_disease_confirmed'];
		$data['disease_confirmed']    =   $this->mbio->get_one_diagnosis_code($data['case_disease_confirmed']);
		$data['phi_range']     		  =   $this->mbio->get_phi_range($data['bio_case_details']['location_id']);
		$data['init_notification_id'] =   $data['notification_id'];
		$data['init_summary_id']      =   $data['notify_info']['summary_id'];
		$data['init_visit_date']      =   $data['notify_info']['notify_date'];
		$data['init_started_date']    =   $data['notify_info']['started_date'];
		...
		$data['case_location_id']     =   $data['bio_case_details']['location_id'];
		$data['branch_info']    = $this->mbio->get_clinic_info($data['case_location_id']);
		...
		$data['est_age']				=	($data['now_id'] - mktime(0, 0, 0, $broken_age['mm'], $broken_age['dd'], $broken_age['yyyy'])) / (60*60*24*365.25);
        $data['lab_list']       = $this->mbio->get_patcon_lab($data['init_summary_id']);
        $data['bio_inv_household'] = $this->mbio->get_investigate_details_per_biocase($data['bio_case_id'],'Household');
        $data['bio_inv_other'] = $this->mbio->get_investigate_details_per_biocase($data['bio_case_id'],'Other');
		if(count($data['lab_list'])) {
			$data['lab_package_id']	= $data['lab_list'][0]['lab_package_id'];
			$data['package_code']= $data['lab_list'][0]['package_code'];
			$data['lab_result']= $data['lab_list'][0]['summary_result'];
		...
		if ($_SESSION['thirra_mode'] == "bio_mobile"){
			...
			$new_body   =   "bio/bio_print_form411_html";
			$new_footer =   "bio/footer_bio_html";
		}
		// Output Format
		$data['output_format'] 	= $this->uri->segment(3);
		$data['filename']		=	"THIRRA-Form411-".$data['init_summary_id'].".pdf";
		$this->load->vars($data);
		if($data['output_format'] == 'pdf') {
			...
			$mpdf=new mPDF('win-1252','A4-L','','',15,15,5,15,10,10);
    ...
    } // end of function print_form411($id)
