 ...
 */
class Ehr_dashboard extends MY_Controller 
{
    ...
    {	
		...
		*/
		...
		$data['incoming_referrals'] = $this->memr_rdb->get_incoming_referrals($data['location_id']); // Old style
		//$data['incoming_referrals'] = $this->memr_rdb->get_incoming_referrals_staged($data['location_id']);
