...
{
    function breadcrumbs($main_class,$cont_name,$level1_method=NULL,$level1_name=NULL,$level2_method=NULL,$level2_name=NULL)  // Create bread crumb
    {
        $bread_crumbs   =    "";//"<a href='".base_url()."index.php/ehr_dashboard'>Home</a> > ";
        $bread_crumbs   .=    "<a href='".base_url()."index.php/".$main_class."'>".$cont_name."</a>";
        if($level1_method){
            $bread_crumbs   .=    " > <a href='".base_url()."index.php/".$level1_method."'>".$level1_name."</a>";
            if($level2_method){
                $bread_crumbs   .=    " > <a href='".base_url()."index.php/".$level2_method."'>".$level2_name."</a>";
            }
        }
        return $bread_crumbs;
